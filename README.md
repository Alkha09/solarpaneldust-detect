...
- 🛰️ **Drone-based inspection** — Aerial imagery for large-scale solar farms, enabling coverage beyond fixed cameras.
- ☁️ **Cloud deployment** — Hosting the model and API on a cloud platform (AWS/GCP/Azure) for remote, multi-site access.
